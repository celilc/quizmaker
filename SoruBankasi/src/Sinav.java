...
public class Sinav {
    ...
    public Sinav(int id, String ders_adi, String soru_tipi, String soru, String sik1, String sik2, String sik3, String sik4, String cevap, int zorluk_derecesi, int puan) {
        this.id = id;
